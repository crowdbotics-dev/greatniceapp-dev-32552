...
## Project Structure
    ...
    ├── greatniceapp_dev_32552  # Django project configurations
...
1. Clone this repo and `cd greatniceapp_dev_32552`
...
2. Clone this repo and `cd greatniceapp_dev_32552`
